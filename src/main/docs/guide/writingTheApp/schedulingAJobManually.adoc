...
<1> Annotate `Application.groovy` with `@Singleton` to register it in the application context.
...
----
include::{sourceDir}/src/main/groovy/example/micronaut/EmailTask.groovy[]
----
...
----
include::{sourceDir}/src/main/groovy/example/micronaut/RegisterUseCase.groovy[]
----
